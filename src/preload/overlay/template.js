...
'        <input id="cuckoo-retry-delay-min" type="number" min="0" step="500" value="4000" class="cuckoo-settings-input" />',
'        <span class="cuckoo-settings-hint">至</span>',
'        <input id="cuckoo-retry-delay-max" type="number" min="0" step="500" value="10000" class="cuckoo-settings-input" />',
'        <span class="cuckoo-settings-hint">ms</span>',
'      </div>',
'      <div class="cuckoo-settings-row">',
...
'      </div>',
'      <div class="cuckoo-settings-row">',
'        <span class="cuckoo-settings-hint">429 超限间隔</span>',
'        <input id="cuckoo-retry-429-delay" type="number" min="0" step="1000" value="60000" class="cuckoo-settings-input" />',
'        <span class="cuckoo-settings-hint">ms</span>',
'      </div>',
'      <div class="cuckoo-settings-row">',
'        <span class="cuckoo-settings-hint">429 超限次数（负数=无限）</span>',
...
'      </div>',
'      <div class="cuckoo-settings-row">',
'        <span class="cuckoo-settings-hint">挂起超时（无数据超时判定失败）</span>',
'        <input id="cuckoo-xhr-idle-timeout" type="number" min="0" step="1000" value="90000" class="cuckoo-settings-input" />',
'        <span class="cuckoo-settings-hint">ms</span>',
'      </div>',
'      <div class="cuckoo-settings-row">',
'        <span class="cuckoo-settings-hint">工具循环超时提示词</span>',
'        <input id="cuckoo-watchdog-prompt" type="text" value="请继续" class="cuckoo-settings-input" style="width:160px;" />',
'      </div>',
'      <div class="cuckoo-settings-row">',
'        <span class="cuckoo-settings-hint">工具循环催继续次数（负数=无限）</span>',
...
'      <div class="cuckoo-settings-row">',
'        <input id="cuckoo-delay-min" type="number" min="0" max="10000" step="100" value="2000" class="cuckoo-settings-input" />',
'        <span class="cuckoo-settings-hint">至</span>',
'        <input id="cuckoo-delay-max" type="number" min="0" max="10000" step="100" value="4000" class="cuckoo-settings-input" />',
'        <span class="cuckoo-settings-hint">ms</span>',
'      </div>',
'    </div>',
'    <div class="cuckoo-actions">',
